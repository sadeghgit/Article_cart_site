...
(function($) { // Hide scope, no $ conflict
    ...
    function TimeEntry() {
        ...
        this._defaults = {
            ...
            spinnerImage: 'spinnerUpDown.png', // The URL of the images to use for the time spinner
            // Seven images packed horizontally for normal, each button pressed, and disabled
            spinnerSize: [15, 15, 8], // The width and height of the spinner image,
        ...
        _connectTimeEntry: function(target, options) {
            ...
            var spinner = (!spinnerImage ? null :
                $('<span class="timeEntry_control" style="display: inline-block; ' +
                   'background: url(\'../components/com_article_cart/assets/images/' + spinnerImage + '\') 0 0 no-repeat; ' +
